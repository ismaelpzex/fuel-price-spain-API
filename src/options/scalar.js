module.exports = {
  ...
  swagger: {
    info: {
      title: "FUEL PRICE SPAIN API",
      description:
        "FuelPriceSpainAPI is a RESTful API that provides up-to-date information on fuel prices at gas stations across Spain. This API is designed for developers and businesses who need accurate and real-time fuel pricing data for various applications such as fuel price comparison, location-based services, and energy management. The API offers nationwide coverage and delivers data in JSON format.",
      version: "0.1.0"
    },
    tags: [
      {
